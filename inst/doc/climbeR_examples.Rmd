...
To start, lets make our forest. The following code is taken from the examples section of the [Ranger documentation](https://CRAN.R-project.org/package=ranger).
